...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void SendMail(string toemail, string sndr)
    {
        ...
        body += "\n\n\n\t\tIf you can't answer please forward it to keralakrishibhavan@gmail.com .";
        // smtp settings
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            string cmdstr3 = "select email from username where placeofkrishi ='" + Session["Place"] + "' and autho = 1";
            SqlCommand authent = new SqlCommand(cmdstr3, con);
            string email = authent.ExecuteScalar().ToString();
            SendMail(email,Session["Mail"].ToString());
