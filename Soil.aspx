<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Soil.aspx.cs" Inherits="Crop" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h1 style="border-style: ridge; border-width: medium; font-family: 'Cooper Black'; font-size: large; color: #FFFFFF; text-align: center; background-color: #3399FF;">Types of Soil</h1>
