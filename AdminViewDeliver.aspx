<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminViewDeliver.aspx.cs" Inherits="AdminViewDeliver" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style="width: 84%; height: 390px; background-color: rgba(255, 255, 255, 0.7); padding-left: 100px; padding-right: 100px">
        <asp:Panel ID="Panel1" runat="server" Height="380px" ScrollBars="Auto">
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="cartID" DataSourceID="Cart2">
        ...
        <asp:SqlDataSource ID="Cart2" runat="server" ConnectionString="<%$ ConnectionStrings:KrishibhavanConnectionString %>" DeleteCommand="DELETE FROM [cart] WHERE [cartID] = @cartID" InsertCommand="INSERT INTO [cart] ([username], [items], [ItemName], [ItemPrize], [picture], [Amont], [Grand]) VALUES (@username, @items, @ItemName, @ItemPrize, @picture, @Amont, @Grand)" SelectCommand="SELECT * FROM [cart] WHERE ([Grand] = @Grand)" UpdateCommand="UPDATE [cart] SET [username] = @username, [items] = @items, [ItemName] = @ItemName, [ItemPrize] = @ItemPrize, [picture] = @picture, [Amont] = @Amont, [Grand] = @Grand WHERE [cartID] = @cartID">
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="Grand" Type="Int32" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="username" Type="String" />
                <asp:Parameter Name="items" Type="Int32" />
