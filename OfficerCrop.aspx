<%@ Page Language="C#" MasterPageFile="~/Officer.master" AutoEventWireup="true" CodeFile="OfficerCrop.aspx.cs" Inherits="Crop" %>
    ...
    <table style="width: 50%;margin-top:50px">
        <tr>
            ...
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:KrishibhavanConnectionString %>" SelectCommand="SELECT [commonname] FROM [crops]"></asp:SqlDataSource>
            </td>
            <td>
