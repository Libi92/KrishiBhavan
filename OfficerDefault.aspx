<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Officer.master" AutoEventWireup="true"
    CodeFile="OfficerDefault.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div style="height: 380px; width: 100%; position: absolute; margin: inherit; top:150px">
        <div style="border: medium double #000080; margin: inherit; padding: inherit; float: left; width: 20%; height: 360px; background-color: rgba(255, 255, 255,0.7); text-align: center">
            ...
            <asp:Label ID="Label1" runat="server" Visible="False" BackColor="#99CCFF" Font-Names="Verdana" Font-Size="14px" ForeColor="#993300"></asp:Label>
            <br />
            <br /><br />
            ...
            <br />
            <br />
            <a href="OfficerChangePassword.aspx" style="font-family:Verdana">Change Password</a>
        </div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" DataSourceID="SqlDataSource1" DataTextField="District" DataValueField="District" Height="22px" Width="151px" >
                            </asp:DropDownList>
