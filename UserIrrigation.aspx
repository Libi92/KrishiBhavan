<%@ Page Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="UserIrrigation.aspx.cs" Inherits="Crop" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style="width:100%; height:400px; background-color:rgba(255, 255, 255, 0.7);text-align:center">
    <h1 style="border-style: ridge;font-family:Verdana; border-width: medium;  font-family: 'Cooper Black'; font-size: large; color: #FFFFFF; text-align: center; background-color: #3399FF;">Critical Growth Stages and Water Requirements of Important Crops</h1>
