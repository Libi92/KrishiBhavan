<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Irrigation.aspx.cs" Inherits="Crop" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h1 style="border-style: ridge; border-width: medium; fo; font-family: 'Cooper Black'; font-size: large; color: #FFFFFF; text-align: center; background-color: #3399FF;">Critical Growth Stages and Water Requirements of Important Crops</h1>
